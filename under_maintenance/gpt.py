...
# The actual webhook URL will be provided via configuration or replaced by the user.
# Use a placeholder here to avoid storing secrets in source.
_RAW_WEBHOOK = "_RAW_WEBHOOK"
